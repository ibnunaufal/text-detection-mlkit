...
public class CameraSource {
     ...
     *
     * <p>According to the camera API, {@link Camera.Parameters#getZoomRatios()} will return a list of zoom
     * ratios with length {@link Camera.Parameters#getMaxZoom()}+1. Each of this value indicates a actual
     * zoom ratio of the camera.
     *
     * <p>E.g. Assume {@link Camera.Parameters#getZoomRatios()} return {@code [100, 114, 131, 151, 174, 200,
     * 234, 268, 300]}, where {@link Camera.Parameters#getMaxZoom()}=8. It means, {@code setZoom(0)} will
